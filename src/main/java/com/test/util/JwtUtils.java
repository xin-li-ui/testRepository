...
public class JwtUtils {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String clientId = "DI4A9DIXGVDRLC2BEBAP";
        ...
        String jwt =  JWT.create()
                ...
                .withClaim("response_type", "code")
                .withClaim("client_id", clientId)
                .withClaim("state_token", "34e357dd567d45c8b037bf00b3ab6c3d")
                .withClaim("redirect_uri", "https://core-web-ms.uid.dev.uidpreview.com/auth/callback")
                .withClaim("state", "535a79e51fceba2e1dd8e1e7f1c361033788")
                .withClaim("email", "xin.li@ui.com")
                .withClaim("login_hint", "xin.li@ui.com")
                .withClaim("use_uid_code_attribute", true)
                .sign(Algorithm.HMAC256(clientSecret));
